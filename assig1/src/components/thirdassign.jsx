...
//how to pass array as obj from app to page?
    ...
    return(
        <div>
              {posts.map((vals)=>{
                        ...
                        <div>
                            <ul>
                            <li class="list-group-item list-group-item-primary">USER ID: {vals.userId}</li>
                            <ul>
                            <li class="list-group-item list-group-item-success">ID: {vals.id}</li>
                            <li class="list-group-item list-group-item-success">TITLE: {vals.title}</li>
                            <li class="list-group-item list-group-item-success">BODY: {vals.body}</li>
                            </ul>
                            </ul>
                        </div>
                        )
...
const Thirdassign = () => {
    //if array decl in same page do not pass it from main function third assign
  return (
    <div>
        {Table(posts)}
        <hr />
